...
public final class MTLGraphicsDevice extends GraphicsDevice
        implements DisplayChangedListener, ScaledDevice {
    ...
    public MTLGraphicsDevice(final int displayID) {
    ...
    public int getDisplayID() {
        return getCGDisplayID();
    }

    @Override
    public Rectangle getDefaultBounds() {
        return getDefaultConfiguration().getBounds();
    }
