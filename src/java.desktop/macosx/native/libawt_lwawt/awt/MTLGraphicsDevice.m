...
Java_sun_awt_MTLGraphicsDevice_nativeGetXResolution
 ...
 */
JNIEXPORT jdouble JNICALL
Java_sun_awt_MTLGraphicsDevice_nativeGetYResolution
  (JNIEnv *env, jclass class, jint displayID)
{
    // CGDisplayScreenSize can return 0 if displayID is invalid
    CGSize size = CGDisplayScreenSize(displayID);
...
Java_sun_awt_MTLGraphicsDevice_nativeGetScreenInsets
  (JNIEnv *env, jclass class, jint displayID)
{
    jobject ret = NULL;
...
Java_sun_awt_MTLGraphicsDevice_nativeSetDisplayMode
 ...
 */
JNIEXPORT jobject JNICALL
Java_sun_awt_MTLGraphicsDevice_nativeGetDisplayMode
(JNIEnv *env, jclass class, jint displayID)
{
    jobject ret = NULL;
    CGDisplayModeRef currentMode = CGDisplayCopyDisplayMode(displayID);
...
Java_sun_awt_MTLGraphicsDevice_nativeGetDisplayModes
(JNIEnv *env, jclass class, jint displayID)
{
 ...
 */
JNIEXPORT jdouble JNICALL
Java_sun_awt_MTLGraphicsDevice_nativeGetScaleFactor
(JNIEnv *env, jclass class, jint displayID)
{
 ...
 */
JNIEXPORT jstring JNICALL Java_sun_awt_MTLGraphicsDevice_nativeGetMetalDeviceName
  (JNIEnv *env, jclass class, jint displayID)
{
