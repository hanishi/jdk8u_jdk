...
Java_sun_awt_MTLGraphicsEnvironment_getDisplayIDs
...
Java_sun_awt_MTLGraphicsEnvironment_getMainDisplayID
(JNIEnv *env, jclass class)
{
...
(CGDirectDisplayID display, CGDisplayChangeSummaryFlags flags, void *userInfo)
{
    ...
    [ThreadUtilities performOnMainThreadWaiting:NO block:^() {
        ...
        JNFPerformEnvBlock(JNFThreadDetachImmediately, ^(JNIEnv *env) {
            ...
            static JNF_CLASS_CACHE(jc_CGraphicsEnvironment, "sun/awt/MTLGraphicsEnvironment");
...
Java_sun_awt_MTLGraphicsEnvironment_registerDisplayReconfiguration
...
Java_sun_awt_MTLGraphicsEnvironment_deregisterDisplayReconfiguration
